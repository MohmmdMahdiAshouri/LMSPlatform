...
import { EmailNotVerifiedException } from '@modules/identity/authentication/domain/exceptions/email-not-verified.exception';
...
export class LoginHandler implements ICommandHandler<LoginCommand> {
    ...
    async execute(command: LoginCommand): Promise<any> {
        ...
        //check this device has been logged in
